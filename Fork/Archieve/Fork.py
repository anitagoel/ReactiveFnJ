...
#        },
#        "object": {
#          "key": "to_process/testfile__part1__of5.csv"
#        }      }    }  ]}
...
def lambda_handler(event, context):
    ...
    for record in event['Records']:
        ...
        key = record['s3']['object']['key'] # key = to_process/testfile__part2__of5.csv
        input_file = os.path.join(bucket, key) # input_file = extsorting/to_process/testfile__part2__of5.csv 
        # os.path.basename(input_file) will return testfile__part2__of5.csv
        # os.path.splitext(os.path.basename(input_file))[0] will return extsorting/to_process/testfile__part2__of5
        # output_file_name = extsorting/to_process/testfile__part2__of5
